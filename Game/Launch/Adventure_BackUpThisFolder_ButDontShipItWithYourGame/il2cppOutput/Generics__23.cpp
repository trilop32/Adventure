...
IL_0035:
	{
		...
		V_1 = L_10;
		int32_t L_11 = V_1;
		Dictionary_2_Resize_m1848C4049280E2E8A714B150C3ACFA6B325424A7(__this, L_11, (bool)0, il2cpp_rgctx_method(method->klass->rgctx_data, 54));
		int32_t L_12 = V_1;
		return L_12;
	}
}
...
IL_0009:
	{
		RuntimeObject* L_1 = ___1_value;
		ThrowHelper_IfNullAndNullsAreIllegalThenThrow_TisKeyValuePair_2_tFC32D2507216293851350D29B64D79F950B55230_mA8FD37CBB582E1FE03968EF5D92D20CE772AAA48(L_1, (int32_t)((int32_t)15), il2cpp_rgctx_method(method->klass->rgctx_data, 58));
	}
	try
	{
		{
		...
		try
		{
			...
			RuntimeObject* L_4 = ___1_value;
			Dictionary_2_set_Item_mA4F9BFFBD73F29377E9E05C47558D282BCBB0DD3(__this, L_3, ((*(KeyValuePair_2_tFC32D2507216293851350D29B64D79F950B55230*)UnBox(L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 15)))), il2cpp_rgctx_method(method->klass->rgctx_data, 59));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
